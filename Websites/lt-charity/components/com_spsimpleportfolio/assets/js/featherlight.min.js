        ...
        t.prototype = {
            ...
            setup: function(t, n) {
                ...
                return o.$instance = a.clone().addClass(o.variant), o.$instance.on(o.closeTrigger + "." + o.namespace, (function(t) {
                    var n = e(t.target);
                    ("background" === o.closeOnClick && n.is("." + o.namespace) || "anywhere" === o.closeOnClick || n.is(i)) && (t.preventDefault(), o.close())
                })), this
            },
            getContent: function() {
                var t = this,
            ...
            open: function(o) {
                var r = this;
                if (!(o && o.isDefaultPrevented() || !1 === r.beforeOpen(o))) {
                    o && o.preventDefault();
                    var a = r.getContent();
            ...
            close: function(o) {
                var r = this;
                return !1 !== r.beforeClose(o) && (r.constructor._opened.remove(r._openedCallback), t.current() || (e(document).off("keyup." + t.namespace, n), r.constructor._keyHandlerInstalled = !1), void r.$instance.fadeOut(r.closeSpeed, (function() {
