...
! function(e) {
    ...
    v.prototype = {
        ...
        open: function(i) {
            ...
            if (!t.isOpen) {
                ...
                return t.isIE7 && (h += " mfp-ie7"), h && t._addClassToMFP(h), t.updateItemHTML(), b("BuildControls"), e("html").css(g), t.bgOverlay.add(t.wrap).prependTo(t.st.prependTo || e(document.body)), t._lastFocusedEl = document.activeElement, setTimeout((function() {
                    t.content ? (t._addClassToMFP(f), t._setFocus()) : t.bgOverlay.addClass(f), n.on("focusin" + u, t._onFocusIn)
                }), 16), t.isOpen = !0, t.updateSize(m), b(d), i
            }
            t.updateItemHTML()
        },
        close: function() {
        ...
        appendContent: function(e, i) {
            t.content = e, e ? t.st.showCloseBtn && t.st.closeBtnInside && !0 === t.currTemplate[i] ? t.content.find(".mfp-close").length || t.content.append(I()) : t.content = e : t.content = "", b("BeforeAppend"), t.container.addClass("mfp-" + i + "-holder"), t.contentContainer.append(t.content)
        },
        parseEl: function(i) {
            var n, o = t.items[i];
            if (o.tagName ? o = {
        ...
        if ("string" == typeof i)
            if ("open" === i) {
                var o, r = h ? n.data("magnificPopup") : n[0].magnificPopup,
            ...
            getAjax: function(i) {
                ...
                var n = e.extend({
                    ...
                    success: function(n, o, r) {
                        ...
                        b("ParseAjax", a), t.appendContent(e(a.data), z), i.finished = !0, O(), t._setFocus(), setTimeout((function() {
                            t.wrap.addClass(f)
    ...
    e.magnificPopup.registerModule("image", {
        ...
        proto: {
            initImage: function() {
                var i = t.st.image,
                    n = ".image";
                t.types.push("image"), C(d + n, (function() {
            ...
            getImage: function(i, n) {
                var o = 0,
                    r = function() {
                        i && (i.img[0].complete ? (i.img.off(".mfploader"), i === t.currItem && (t._onImageHasSize(i), t.updateStatus("ready")), i.hasSize = !0, i.loaded = !0, b("ImageLoadComplete")) : 200 > ++o ? setTimeout(r, 100) : a())
                    },
                    a = function() {
                ...
                }, i), t.resizeImage(), i.hasSize ? (B && clearInterval(B), i.loadError ? (n.addClass("mfp-loading"), t.updateStatus("error", s.tError.replace("%url%", i.src))) : (n.removeClass("mfp-loading"), t.updateStatus("ready")), n) : (t.updateStatus("loading"), i.loading = !0, i.hasSize || (i.imgHidden = !0, n.addClass("mfp-loading"), t.findImageSize(i)), n)
            }
        }
        ...
        proto: {
            ...
            _getOffset: function(i) {
                ...
                var s = {
                    width: n.width(),
                    height: (h ? n.innerHeight() : n[0].offsetHeight) - a - r
                };
    ...
    e.magnificPopup.registerModule(A, {
        ...
        proto: {
            initIframe: function() {
                t.types.push(A), C("BeforeChange", (function(e, t, i) {
                    t !== i && (t === A ? F() : i === A && F(!0))
                })), C(s + "." + A, (function() {
                    F()
                }))
    ...
    e.magnificPopup.registerModule("gallery", {
        ...
        proto: {
            initGallery: function() {
                var i = t.st.gallery,
                    o = ".mfp-gallery";
                return t.direction = !0, !(!i || !i.enabled) && (r += " mfp-gallery", C(d + o, (function() {
        ...
        proto: {
            initRetina: function() {
                if (window.devicePixelRatio > 1) {
                    var e = t.st.retina,
                        i = e.ratio;
                    (i = isNaN(i) ? i() : i) > 1 && (C("ImageHasSize." + W, (function(e, t) {
                        t.img.css({
