...
FOR %%x IN ("X:\Works\Works\PO\Websites\xamp\php\pear") DO (if %%x=="%PMTPMTPMT%" GOTO :NOTINSTALLED)

REM Check PEAR global ENV, set them if they do not exist
IF "%PHP_PEAR_INSTALL_DIR%"=="" SET "PHP_PEAR_INSTALL_DIR=X:\Works\Works\PO\Websites\xamp\php\pear"
IF "%PHP_PEAR_BIN_DIR%"=="" SET "PHP_PEAR_BIN_DIR=X:\Works\Works\PO\Websites\xamp\php"
IF "%PHP_PEAR_PHP_BIN%"=="" SET "PHP_PEAR_PHP_BIN=X:\Works\Works\PO\Websites\xamp\php\php.exe"
GOTO :INSTALLED
