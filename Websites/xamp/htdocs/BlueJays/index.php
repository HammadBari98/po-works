...
<head>
    ...
    <!-- fancybox css -->
    <link href="Home/css/jquery.fancybox.css" rel="stylesheet">
    <link href="Home/css/style.css" rel="stylesheet">
    <!-- revolution slider css -->
    <link rel="stylesheet" type="text/css" href="Home/css/revolution/settings.css">
    <link rel="stylesheet" type="text/css" href="Home/css/revolution/layers.css">
    <link rel="stylesheet" type="text/css" href="Home/css/revolution/navigation.css">
...
<body class="home header-sticky header-v1 hide-topbar-mobile">
    <div id="page" class="hfeed site">
        ...
        <!-- masthead -->
         ...
         <!--Main Slider-->
                ...
                <div id="slider1" class="rev_slider" data-version="5.0">
                    <ul>
                        ...
                        <li data-index="rs-1" data-transition="slidingoverlayhorizontal" data-slotamount="default"
                            ...
                            data-thumb="Imgs/s1.jpg" data-rotate="0" data-fstransition="fade"
                            data-fsmasterspeed="1500" data-fsslotamount="7" data-saveperformance="off"
                            data-title="Make an Impact">
                            <!-- MAIN IMAGE -->
                            <img src="Imgs/s1.jpg" alt="" data-bgposition="center center"
                                data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="10" class="rev-slidebg"
                                data-no-retina>
                            <!-- LAYERS -->

                            <!-- LAYER NR. 1 -->
                            <div class="tp-caption tp-resizeme bigtitle text-white rs-parallaxlevel-0"  style="color:#253E87 !important; "
                                id="slide-1-layer-2" data-x="['left','left','left','left']"
                                data-hoffset="['50','50','50','30']" data-y="['top','top','top','top']"
                                data-voffset="['180','160','130','80']" data-fontsize="['59','46','40','36']"
                                data-lineheight="['70','60','50','45']" data-fontweight="['600','600','700','700']"
                                ...
                                data-splitout="none" data-responsive_offset="on">We
                                Offer landscaping
                                <br>Services Since 1947
                            </div>
                            <!-- LAYER NR. 2 -->
                            <div class="tp-caption tp-resizeme text-white rs-parallaxlevel-0 mobilehide"
                                id="slide-1-layer-3" data-x="['left','left','left','left']"
                                data-hoffset="['50','50','50','30']" data-y="['top','top','top','top']"
                                data-voffset="['350','290','250','190']" data-fontsize="['18','18','16','13']"
                                data-lineheight="['30','30','28','25']" data-fontweight="['400','400','600','600']"
                                ...
                                data-transform_out="x:-100px;opacity:0;s:700;e:Power2.easeInOut" data-start="1800"
                                data-splitin="none" data-splitout="none" data-responsive_offset="on">
                                <!-- 30+ years of
                                experience
                                our staff keep your property looking
                            ...
                            <div class="tp-caption tp-resizeme text-white rs-parallaxlevel-0"   id="slide-1-layer-4"
                                ...
                                data-y="['top','top','top','top']" data-voffset="['450','370','340','270']"
                                data-fontsize="['18','18','16','16']" data-lineheight="['30','30','30','30']"
                                data-fontweight="['400','400','600','600']" data-width="['700','650','600','420']"
                                ...
                                data-transform_out="auto:auto;s:1000;e:Power3.easeInOut;s:1000;e:Power3.easeInOut;"
                                data-mask_in="x:0px;y:[100%];s:inherit;e:inherit;" data-start="1000" data-splitin="none"
                                data-splitout="none" data-responsive_offset="on"><a href="about-us.php"style="background-color:#253E87 !important;color:white !important;"
                                    class="slider-link-style1">MORE
                                    ABOUT OUR COMPANY </a>
                            </div>
                        </li>
                        ...
                        <li data-index="rs-2" data-transition="slidingoverlayhorizontal" data-slotamount="default"
                            data-easein="default" data-easeout="default" data-masterspeed="default"
                            data-thumb="Imgs/s2.jpg" data-rotate="0" data-fstransition="fade"
                            data-fsmasterspeed="1500" data-fsslotamount="7" data-saveperformance="off"
                            data-title="Make an Impact">
                            <!-- MAIN IMAGE -->
                            <img src="Imgs/s2.jpg" alt="" data-bgposition="center center"
                                data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="10" class="rev-slidebg"
                                data-no-retina>
                            <!-- LAYERS -->
                        ...
                        <li data-index="rs-3" data-transition="slidingoverlayhorizontal" data-slotamount="default"
                            ...
                            data-title="Make an Impact">
                            <!-- MAIN IMAGE -->
                            <img src="Imgs/s3.jpg" alt="" data-bgposition="center center"
                                data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="10" class="rev-slidebg"
                                data-no-retina>
                            <!-- LAYERS -->
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-12 nopadd">
                            <div class="grd-icon-box grd-icon-box-2 icon-theme-dark radius-5 services-home-1 clearfix">
                                <div class="icon-box-wrapter">
                                    ...
                                    <div class="content">
                                        <div class="descreption">There anyone loves pursues desires to obtain pain of
                                            itself, because it is pain but because occasionally.</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-4 col-sm-12 nopadd">
                            <div class="grd-icon-box grd-icon-box-2 icon-theme-dark radius-5 services-home-2 clearfix">
                                <div class="icon-box-wrapter">
                                    ...
                                    <div class="content">
                                        <div class="descreption">Great explorer off the truth master builder human is
                                            happiness one rejects dislikes avoid pleasure.</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-12">
                            <div class="col-xs-12 grd-icon-box grd-icon-box-3 icon-theme-light  border">
                                <div class="icon-box-wrapter">
                                    <a href="#" class="icon">
                                        <div class="icon-content">
                                            <span class="svg-icon"><img src="Imgs/doctor-313.png" style="height: 100px;margin:auto; text-align: center;" alt=""></span>
                                        </div>
                                    </a>
                                    <a href="#" class="emtry-title">
                                        <p class="title">Our
                                    ...
                                    <div class="content">
                                        <div class="descreption">Which includes lawn mowing, fertilizing, spring, fall
                                            cleanups and tree care.</div>
                                    </div>
                                </div>
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-12">
                            <div class="grd-image-box-1 icon-theme-light">
                                ...
                                <div class="entry_thumbnail">
                                    <img src="Imgs/blog-post-2-1.jpg" alt="04" width="600" height="324">
                                    <a href="#" class="hover"></a>
                                </div>
                                <div class="entry-content">Complete range of landscaping services all designed to
                                    enhance
                                    the beauty of your home and property…</div>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-4 col-sm-12">
                            <div class="grd-image-box-1 icon-theme-light">
                                ...
                                <div class="entry_thumbnail">
                                    <img class="" src="Imgs/blog-post-3.jpg" alt="04" width="600" height="324">
                                    <a href="#" class="hover"></a>
                                </div>
                                <div class="entry-content">Environmental problems result when exotic plants are placed
                                    in
                                    the landscape occurs toil some great…</div>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row grd-portfolio-shortcode">
                        <div class="col-sm-6 col-md-3  portfolio-item">
                            <div class="content-item">
                                <div class="entry-header">
                                    <a href="#" class="entry-thumbnail"><img alt="Communal Garden"
                                            src="Imgs/blog-post-6.jpg"></a>
                                </div>
                                <div class="entry-content">
                                    <div class="entry-title">
                                        <a href="#">
                                            <h3 class="title">Communal Garden</h3>
                                        </a>
                                        <div class="entry-meta"><a class="category" href="#">Lawn Care</a></div>
                                    </div>
                                    <div class="readmore">
                                        <a href="#" class="entry-read-more">
                                            <div class="read-more"><span class="svg-icon"><i
                                                        class="flaticon-right"></i></span> Read more</div>
                                        </a>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-sm-6 col-md-3  portfolio-item">
                            <div class="content-item">
                                <div class="entry-header">
                                    <a href="#" class="entry-thumbnail"><img alt="Communal Garden"
                                            src="Imgs/blog-post-2-1.jpg"></a>
                                </div>
                                <div class="entry-content">
                                    <div class="entry-title">
                                        <a href="#">
                                            <h3 class="title">Courtyard Garden</h3>
                                        </a>
                                        <div class="entry-meta"><a class="category" href="#">Lawn Care</a></div>
                                    </div>
                                    <div class="readmore">
                        ...
                        <div class="col-sm-6 col-md-3  portfolio-item">
                            <div class="content-item">
                                <div class="entry-header">
                                    <a href="#" class="entry-thumbnail"><img alt="Communal Garden"
                                            src="Imgs/blog-post-3.jpg"></a>
                                </div>
                                <div class="entry-content">
                                    <div class="entry-title">
                                        <a href="#">
                                            <h3 class="title">Formal Garden</h3>
                                        </a>
                                        <div class="entry-meta"><a class="category" href="#">Snow Removing</a></div>
                                    </div>
                                    <div class="readmore">
                                        <a href="#" class="entry-read-more">
                                            <div class="read-more"><span class="svg-icon"><i
                        ...
                        <div class="col-sm-6 col-md-3  portfolio-item">
                            <div class="content-item">
                                <div class="entry-header">
                                    <a href="#" class="entry-thumbnail"><img alt="Communal Garden"
                                            src="Imgs/blog-post-1.jpg"></a>
                                </div>
                                <div class="entry-content">
                                    <div class="entry-title">
                                        <a href="#">
                                            <h3 class="title">Roof Garden</h3>
                                        </a>
                                        <div class="entry-meta"><a class="category" href="#">Planting</a></div>
                                    </div>
                                    <div class="readmore">
                                        <a href="#" class="entry-read-more">
                                            <div class="read-more"><span class="svg-icon"><i
            ...
            <div class="working-process-1">
                <div class="container">
                    <div class="grd-section-title  grd_title-type-1 sc-dark text-center margbtm30">
                        ...
                        <div class="desc">
                            <p>Contact our office for a free quote! It is always good to have a rough idea on your
                                budget at
                                this stage to enable us to quote as necessary.</p>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-sm-6 col-md-3 col-xs-12">
                            <div class="grd-icon-box grd-icon-box-4 icon-theme-dark text-center clearfix">
                                <div class="icon-box-wrapter">
                                    <a href="#" class="icon">
                                        <div class="icon-content"><span class="svg-icon"><i
                                                    class="flaticon-consulting"></i></span></div>
                                    </a>
                                    <a href="#" class="emtry-title">
                                        <p class="title">Consultation</p>
                                    </a>
                                    <div class="content">
                                        <div class="descreption"><span>How all this mistaken idea all off work
                                                pleasure.</span></div>
                                    </div>
                                </div>
                        ...
                        <div class="col-sm-6 col-md-3 col-xs-12">
                            <div class="grd-icon-box grd-icon-box-4 icon-theme-dark text-center clearfix">
                                <div class="icon-box-wrapter">
                                    <a href="#" class="icon">
                                        <div class="icon-content"><span class="svg-icon"><i
                                                    class="flaticon-blueprint"></i></span></div>
                                    </a>
                                    <a href="#" class="emtry-title">
                                        <p class="title" title="Design &amp; Planting">Design &amp; Planting</p>
                                    </a>
                                    <div class="content">
                                        <div class="descreption"><span>Expound the actuals teachings<br> explorer the
                                                truth.</span></div>
                                    </div>
                                </div>
                                <div class="text-footer">Step 2</div>
                        ...
                        <div class="col-sm-6 col-md-3 col-xs-12">
                            <div class="grd-icon-box grd-icon-box-4 icon-theme-dark text-center clearfix">
                                <div class="icon-box-wrapter">
                                    <a href="#" class="icon">
                                        <div class="icon-content"><span class="svg-icon"><i
                                                    class="flaticon-park"></i></span></div>
                                    </a>
                                    <a href="#" class="emtry-title">
                                        <p class="title" title="Design &amp; Planting">Completion</p>
                                    </a>
                                    <div class="content">
                                        <div class="descreption"><span>Actual teachings great explorer<br>
                                                master-builder.</span></div>
                                    </div>
                                </div>
                                <div class="text-footer">Step 2</div>
                            </div>
                        ...
                        <div class="col-sm-6 col-md-3 col-xs-12">
                            <div class="grd-icon-box grd-icon-box-4 icon-theme-dark text-center clearfix">
                                <div class="icon-box-wrapter">
                                    <a href="#" class="icon">
                                        <div class="icon-content"><span class="svg-icon"><i
                                                    class="flaticon-gardening"></i></span></div>
                                    </a>
                                    <a href="#" class="emtry-title">
                                        <p class="title" title="Design &amp; Planting">Maintenance</p>
                                    </a>
                                    <div class="content">
                                        <div class="descreption"><span>To take a trivial example, which of<br> all
                                                undertakes labor.</span></div>
                                    </div>
                                </div>
                                <div class="text-footer">Step 2</div>
                            </div>
                    ...
                    <div class="dl_testimorial_carousel testone-slide no-star">
                        <div class="item-testi style-1">
                            <div class="box-text">
                                ...
                                <p class="content"> “Lawn Care helped me transform my dated,patchwork front yard into an
                                    inviting Southern Garden!.”</p>
                            </div>
                            <div class="box-avatar">
                                <img class="" src="Home/images/testimonial/1.png" alt="1" title="1" width="80" height="80">
            ...
            <!--awards-->
            <div class="grd-award-1">
                <div class="container">
                    <div class="grd-section-title  sc-dark grd_title-type-3 text-center">
                        <h3 class="title">Most Award Winning Landscaper</h3>
                        <div class="desc">
                            <div class="content">
                                <span class="line"></span><span>Over 70 Awards</span><span class="line"></span>
                            </div>
                        </div>
                    </div>
                    <div class="grd-award-carousel">
                        <div class="carousel-wrapper award-slider">
                            <div class="item text-center icon-theme-dark">
                                <span class="svg-icon"><i
                                        class="flaticon-award-medal-of-number-one-with-olive-branches"></i></span>
                                <h3 class="title">1989 - 1990</h3>
                                <div class="content">Consumers Choice Award Winner for Best Landscape Contractor.</div>
                                <div class="grd-button-group grd-align-center">
                                    <a href="#" class="grd-button">Start Your Project Today</a>
                                </div>
                            </div>
                            <div class="item text-center icon-theme-dark">
                                <span class="svg-icon"><i
                ...
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-md-4 col-sm-6">
                            <div class="blog-wrapper">
                                <div class="entry-thumbnail">
                                    <a href="#"><img src="Home/images/blogs/blog-1-1.jpg" alt="" width="600"
                                            height="340" /></a>
                                </div>
                                <header class="entry-header">
                                    <div class="entry-meta">
                                        ...
                                        <span class="meta-author"><span>By </span>
                                            <a href="#">steeltheme</a></span>
                                    </div>
                                    <h2 class="entry-title"><a href="#">We Won The Best Landscape Company</a></h2>
                                </header>
                            </div>
                        </div>
                        <div class="col-md-4 col-sm-6">
                            <div class="blog-wrapper">
                                <div class="entry-thumbnail">
                                    <a href="#"><img src="Home/images/blogs/blog-1-2.png" alt="" width="600"
                                            height="340" /></a>
                                </div>
                                <header class="entry-header">
                                    <div class="entry-meta">
                        ...
                        <div class="col-md-4 col-sm-6">
                            <div class="blog-wrapper">
                                <div class="entry-thumbnail">
                                    <a href="#"><img src="Home/images/blogs/blog-1-3.jpg" alt="" width="600"
                                            height="340" /></a>
                                </div>
                                <header class="entry-header">
                                    <div class="entry-meta">
                    ...
                    <div class="row">
                        <div class="col-md-9 pull-right">
                            <div class="grd-section-title  grd_title-type-2 margbtm40">
                                ...
                                <div class="desc">
                                    <p>Please fill the below required information to get a estimate & make an
                                        appoinement
                                        with Lawncare, Our experts will contact you very soon.</p>
                                </div>
                            </div>
                            <form action="#" method="post" class="wpcf7-form contact-home" novalidate="novalidate">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-8">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <input name="address" value="" size="40" placeholder="Address*"
                                                    type="text">
                                            </div>
                                            <div class="col-md-6">
                                                <select name="Service">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <input name="time" value="" size="40" placeholder="09.00 am"
                                                    type="text">
                                            </div>
                                        </div>
                                        <p>
            ...
            <div class="customer-help-1">
                <div class="container">
                    <div class="row">
                        <div class="col-md-4 col-sm-6 col-xs-12 grd-icon-box grd-icon-box-5 icon-theme-light">
                            <div class="icon-box-wrapter">
                                <a href="#" class="icon">
                                    <div class="icon-content"><img class="" src="Home/images/icon/faq.png" alt="faq"
                                            width="64" height="58"></div>
                                </a>
                                <a href="#" class="emtry-title">
                                ...
                                <div class="content">
                                    <div class="descreption">How all this mistaken idea of pleasure &amp;praising pain
                                        completed.</div>
                                </div>
                            </div>
                            <a href="#" class="text-footer"><span class="svg-icon"><i class="flaticon-right"></i></span>
                                Our
                                Locations</a>
                        </div>
                        <div class="col-md-4 col-sm-6 col-xs-12 grd-icon-box grd-icon-box-5 icon-theme-light">
                            <div class="icon-box-wrapter">
                                <a href="#" class="icon">
                                    <div class="icon-content"><img class="" src="Home/images/icon/location.png" alt="faq"
                                            width="64" height="58"></div>
                                </a>
                                <a href="#" class="emtry-title">
                                    <p class="title">Get Replies
                        ...
                        <div class="col-md-4 col-sm-6 col-xs-12 grd-icon-box grd-icon-box-5 icon-theme-light">
                            <div class="icon-box-wrapter">
                                <a href="#" class="icon">
                                    <div class="icon-content"><img class="" src="Home/images/icon/place.png" alt="faq"
                                            width="64" height="58"></div>
                                </a>
                                <a href="#" class="emtry-title">
                                    <p class="title">Get Replies
    ...
    <!-- REVOLUTION JS FILES -->
    <script type="text/javascript" src="Home/js/revolution/jquery.themepunch.tools.min.js"></script>
    <script type="text/javascript" src="Home/js/revolution/jquery.themepunch.revolution.min.js"></script>
    <script type="text/javascript" src="Home/js/revolution/extensions/revolution.extension.actions.min.js"></script>
    <script type="text/javascript" src="Home/js/revolution/extensions/revolution.extension.carousel.min.js"></script>
    <script type="text/javascript" src="Home/js/revolution/extensions/revolution.extension.kenburn.min.js"></script>
    <script type="text/javascript" src="Home/js/revolution/extensions/revolution.extension.layeranimation.min.js"></script>
    <script type="text/javascript" src="Home/js/revolution/extensions/revolution.extension.migration.min.js"></script>
    <script type="text/javascript" src="Home/js/revolution/extensions/revolution.extension.navigation.min.js"></script>
    <script type="text/javascript" src="Home/js/revolution/extensions/revolution.extension.parallax.min.js"></script>
    <script type="text/javascript" src="Home/js/revolution/extensions/revolution.extension.slideanims.min.js"></script>
    <script type="text/javascript" src="Home/js/revolution/extensions/revolution.extension.video.min.js"></script>

    <!-- script JS  -->
    <script src="Home/js/scripts.min.js"></script>
