...
! function(a) {
    ...
    a(b).on("load", function() {
        ...
        _h: function() {
            var a = this.a.val();
            this._af(a) ? this._v(a, !0) : "auto" !== this.b.initialCountry && (this.b.initialCountry ? this._z(this.b.initialCountry.toLowerCase(), !0) : (this.j = this.preferredCountries.length ? this.preferredCountries[0].iso2 : this.p[0].iso2, a || this._z(this.j, !0)), a || this.b.nationalMode || this.b.autoHideDialCode || this.b.separateDialCode || this.a.val("+" + this.s.dialCode)), a && this._u(a, this.b.formatOnInit)
        },
        _i: function() {
        ...
        _u: function(a, c) {
            if (c && b.intlTelInputUtils && this.s) {
                var d = this.b.separateDialCode || !this.b.nationalMode && "+" == a.charAt(0) ? intlTelInputUtils.numberFormat.INTERNATIONAL : intlTelInputUtils.numberFormat.NATIONAL;
        ...
        _z: function(a, b) {
            ...
            if (this.l.parent().attr("title", d), this.b.separateDialCode) {
        ...
        _aa: function() {
            ...
            if (b.intlTelInputUtils && a && this.s) {
                var c = intlTelInputUtils.numberType[this.b.numberType],
        ...
        _ag: function() {
            var a = this.b.separateDialCode ? "+" + this.s.dialCode : "";
            return a + this.a.val()
        },
        _ah: function(a) {
        ...
        handleUtils: function() {
            b.intlTelInputUtils && (this.a.val() && this._u(this.a.val(), this.b.formatOnInit), this._aa()), this.i.resolve()
        }
    }, a.fn[f] = function(b) {
        var c = arguments;
    ...
    }, a.fn[f].version = "9.2.4", a.fn[f].defaults = h;
    for (var j = [
