...
var avadaLiveSearchVars = {
    "live_search": "1",
    "ajaxurl": "https:\/\/wirxpharmacy.com\/wp-admin\/admin-ajax.php",
...
jQuery(window).on("load", function() {
    ...
    }, 100), jQuery(window).on("fusion-resize-horizontal fusion-live-editor-updated", function() {
        setTimeout(function() {
            fusionCalcColumnEqualHeights()
        }, 500)
    })
}), jQuery(window).on("fusion-dynamic-content-render", function(n, u) {
    var o = jQuery(u).find(".fusion-fullwidth.fusion-equal-height-columns");
...
jQuery.fn.fusionCalculateBlogEqualHeights = function() {
    ...
    jQuery().isotope && jQuery(".fusion-blog-layout-grid").each(function() {
    ...
    }), i = jQuery(".fusion-blog-layout-timeline").find(".fusion-timeline-date").last().text(), e = !0, jQuery(".fusion-blog-layout-timeline").find(".fusion-timeline-date").on("click", function() {
    ...
    }), jQuery(".fusion-posts-container-infinite").each(function(n) {
        ...
        jQuery(this).find(".fusion-blog-layout-timeline").length && (u = jQuery(this).find(".fusion-blog-layout-timeline")), o = "", u.closest(".fusion-blog-shortcode").length && (o = "." + u.parents(".fusion-blog-shortcode").attr("class").replace(/\ /g, ".") + " "), u.closest(".fusion-blog-shortcode").parent(".fusion-archives-tb").length && (r = (r = u.closest(".fusion-blog-shortcode").parent(".fusion-archives-tb").data("infinite-post-class")) || ""), jQuery(u).infinitescroll({
            ...
            nextSelector: o + "a.pagination-next",
            itemSelector: o + "div.pagination .current, " + o + "article" + ("" === r ? "" : "." + r) + ":not( .fusion-archive-description ), " + o + ".fusion-collapse-month, " + o + ".fusion-timeline-date",
            loading: {
            ...
            maxPage: u.data("pages") ? u.data("pages") : void 0,
            infid: "b" + n,
            errorCallback: function() {
                u.find(".fusion-post-grid").css("height", ""), jQuery(u).hasClass("isotope") && jQuery(u).isotope()
            }
        }, function(n) {
            jQuery(u).hasClass("fusion-blog-layout-timeline") && (jQuery(n).first(".fusion-timeline-date").text() == i && jQuery(n).first(".fusion-timeline-date").remove(), i = jQuery(u).find(".fusion-timeline-date").last().text(), jQuery(u).find(".fusion-timeline-date").each(function() {
                jQuery(this).next(".fusion-collapse-month").append(jQuery(this).nextUntil(".fusion-timeline-date", ".fusion-post-timeline"))
            }), e || setTimeout(function() {
                jQuery(u).find(".fusion-collapse-month").hide()
            }, 200), setTimeout(function() {
                jQuery(u).find(".fusion-collapse-month").each(function() {
                    jQuery(this).children().length || jQuery(this).remove()
                })
            }, 10), jQuery(u).find(".fusion-timeline-date").unbind("click"), jQuery(u).find(".fusion-timeline-date").on("click", function() {
                jQuery(this).next(".fusion-collapse-month").slideToggle()
            })), fusionInitPostFlexSlider(), jQuery(u).hasClass("fusion-blog-layout-grid") && jQuery().isotope && (jQuery(n).hide(), imagesLoaded(n, function() {
                jQuery(n).fadeIn(), jQuery(u).hasClass("isotope") && (u.hasClass("fusion-portfolio-equal-heights") && u.find(".fusion-post-grid").css("height", ""), jQuery(u).isotope("appended", jQuery(n))), jQuery('[data-spy="scroll"]').each(function() {
                    jQuery(this).scrollspy("refresh")
                })
            })), jQuery(n).each(function() {
                jQuery(this).find(".full-video, .video-shortcode, .wooslider .slide-content").fitVids()
            }), s = u, jQuery(u).hasClass("fusion-blog-layout-timeline") && (s = jQuery(u).parents(".fusion-posts-container-infinite")), t = s.find(".current").html(), s.find(".current").remove(), s.data("pages") == t && (s.parent().find(".fusion-loading-container").hide(), s.parent().find(".fusion-load-more-button").hide()), jQuery(n).find(".fusion-rollover-gallery").length && ("individual" !== fusionBlogVars.lightbox_behavior && a.find(".fusion-rollover-gallery").length ? (l = a.find(".fusion-rollover-gallery").first().data("rel"), a = u.find(".post"), void 0 !== window.$ilInstances[l] && (window.$ilInstances[l].destroy(), delete window.$ilInstances[l], window.avadaLightBox.activate_lightbox(a))) : (window.avadaLightBox.activate_lightbox(jQuery(n)), a = u.find(".post")), window.avadaLightBox.refresh_lightbox()), setTimeout(function() {
                jQuery(window).trigger("resize", [!1])
            }, 500), jQuery.isFunction(jQuery.fn.initElementAnimations) && jQuery(window).initElementAnimations()
        }), (jQuery(u).hasClass("fusion-blog-archive") && "load_more_button" === fusionBlogVars.blog_pagination_type || jQuery(u).hasClass("fusion-posts-container-load-more") || jQuery(u).hasClass("fusion-blog-layout-timeline") && jQuery(u).parent().hasClass("fusion-posts-container-load-more")) && (jQuery(u).infinitescroll("unbind"), (jQuery(u).hasClass("fusion-blog-archive") ? jQuery(u).parent().find(".fusion-load-more-button") : jQuery(u).parents(".fusion-blog-archive").find(".fusion-load-more-button")).on("click", function(i) {
            i.preventDefault(), jQuery(u).infinitescroll("retrieve")
        })), s = u, jQuery(u).hasClass("fusion-blog-layout-timeline") && jQuery(u).parents(".fusion-blog-layout-timeline-wrapper").length && (s = jQuery(u).parents(".fusion-posts-container-infinite")), 1 === parseInt(s.data("pages"), 10) && (s.parent().find(".fusion-loading-container").hide(), s.parent().find(".fusion-load-more-button").hide())
    })
...
jQuery(document).ready(function() {
    ...
    jQuery(".fusion-dropdown-svg").length && jQuery(".fusion-dropdown-svg").each(function() {
        ...
        return "top" === avadaMenuVars.header_position && !jQuery("body.rtl").length || "left" === avadaMenuVars.header_position ? jQuery(this).children(".sub-menu").each(function() {
            var e, n, i, s, u, t, o, a, r, d, l, m, f, h = jQuery(this);
            h.removeAttr("style"), h.show(), h.removeData("shifted"), h.length && (n = (e = h.offset()).left, t = (i = e.top) + (s = h.height()), o = n + (u = h.outerWidth()), r = fusion.getAdminbarHeight(), l = (d = jQuery(window).scrollTop()) + jQuery(window).height(), o > jQuery(window).width() ? (h.addClass("fusion-switched-side"), h.parent().parent(".sub-menu").length ? h.css({
                left: -1 * u
            }) : h.css("left", -1 * u + h.parent().width()), h.data("shifted", 1)) : h.parent().parent(".sub-menu").length && (h.removeClass("fusion-switched-side"), h.parent().parent(".sub-menu").data("shifted") && (h.css("left", -1 * u), h.data("shifted", 1))), "top" !== avadaMenuVars.header_position && t > l && (a = s < l ? -1 * (t - l + 10) : -1 * (i - d - r), jQuery(".fusion-dropdown-svg").length && (h.find("> li > a").off("mouseenter mouseleave"), h.parents("li").find(".fusion-dropdown-svg").removeClass("fusion-svg-active"), a = (m = Math.floor(a / h.find("li").outerHeight())) * h.find("li").outerHeight(), f = h.find("> li:nth-child( " + (Math.abs(m) + 1) + ")"), (jQuery(f).hasClass("current-menu-item") || jQuery(f).hasClass("current-menu-parent") || jQuery(f).hasClass("current_page_item")) && h.parents("li").find(".fusion-dropdown-svg").addClass("fusion-svg-active"), jQuery(f).not(".current-menu-item, .current-menu-parent, .current_page_item").find("> a").on("mouseenter mouseleave", function() {
                h.parents("li").find(".fusion-dropdown-svg").toggleClass("fusion-svg-active")
            })), h.css("top", a)))
        }) : jQuery(this).children(".sub-menu").each(function() {
            var e, n, i, s, u, t, o, a, r, d, l, m, f, h;
        ...
        "top" !== avadaMenuVars.header_position && jQuery(this).find(".fusion-menu-cart-items").each(function() {
            var e, n, i, s = jQuery(this),
                ...
                r = o + a;
            s.css("top", ""), (n = (e = s.offset().top) + u) > r && (i = u < a ? -1 * (n - r + 10) : -1 * (e - o - t), s.css("top", i))
        })
        ...
        var e, n, i, s, u, t, o, a, r, d, l;
        return "top" === avadaMenuVars.header_position && (o = jQuery(".fusion-secondary-main-menu").length ? jQuery(".fusion-header-wrapper .fusion-secondary-main-menu .fusion-row") : jQuery(".fusion-header-wrapper .fusion-row"), a = o.width(), r = o.offset(), d = void 0 !== r ? r.left : 0, l = d + a), jQuery(".side-header-left").length ? this.each(function() {
            jQuery(this).children("li").each(function() {
                var e, n, i, s, u, t, o, a, r = jQuery(this).find(".fusion-megamenu-wrapper");
                r.length && (r.removeAttr("style"), e = jQuery("#side-header").outerWidth() - 1, s = (n = r.offset().top) + (i = r.height()), u = fusion.getAdminbarHeight(), t = jQuery(".side-header-wrapper").offset().top - u, o = jQuery(window).height(), jQuery("body.rtl").length ? r.css({
                    left: e,
                    right: "auto"
                }) : r.css("left", e), s > t + o && jQuery(window).height() >= jQuery(".side-header-wrapper").height() && (a = i < o ? -1 * (s - t - o + 20) : -1 * (n - u), r.css("top", a)))
            })
        }) : jQuery(".side-header-right").length ? this.each(function() {
            jQuery(this).children("li").each(function() {
                var e, n, i, s, u, t, o, a, r = jQuery(this).find(".fusion-megamenu-wrapper");
                r.length && (r.removeAttr("style"), e = -1 * r.outerWidth(), s = (n = r.offset().top) + (i = r.height()), u = fusion.getAdminbarHeight(), t = jQuery(".side-header-wrapper").offset().top - u, o = jQuery(window).height(), jQuery("body.rtl").length ? r.css({
                    left: e,
                    right: "auto"
                }) : r.css("left", e), s > t + o && jQuery(window).height() >= jQuery(".side-header-wrapper").height() && (a = i < o ? -1 * (s - t - o + 20) : -1 * (n - u), r.css("top", a)))
            })
            ...
            jQuery(this).children("li").each(function() {
                var e = jQuery(this),
                    ...
                    r = s.outerWidth(),
                    d = 0;
                s.length && (s.removeAttr("style"), a = o.width(), i - r < u && (r === jQuery(window).width() ? d = i - r : r > a ? d = i - l + (a - r) / 2 : (d = -1 * (n.left - (t - r)), d = -1 * (r - (i - u)), ("left" === avadaMenuVars.logo_alignment.toLowerCase() || "center" === avadaMenuVars.logo_alignment.toLowerCase() && !jQuery(".header-v5").length || jQuery(this).parents(".sticky-header").length) && i - d > t && (d = -1 * (t - i))), s.css("right", d)))
            })
        }) : this.each(function() {
            jQuery(this).children("li").each(function() {
                var e = jQuery(this),
                    ...
                    s = i.outerWidth(),
                    r = 0;
                i.length && (i.removeAttr("style"), a = o.width(), n.left + s > t && (s === jQuery(window).width() ? r = -1 * n.left : s > a ? r = d - n.left + (a - s) / 2 : (r = -1 * (n.left - (t - s)), "right" === avadaMenuVars.logo_alignment.toLowerCase() && n.left + r < u && (r = -1 * (n.left - u))), i.css("left", r)))
            })
        })) : void 0)
    ...
    }), jQuery(".fusion-is-sticky").length && jQuery(".fusion-mobile-sticky-nav-holder").length ? jQuery(".fusion-mobile-menu-icons .awb-icon-bars").attr("aria-controls", jQuery(".fusion-mobile-sticky-nav-holder > ul").attr("id")) : jQuery(".fusion-mobile-menu-icons .awb-icon-bars").attr("aria-controls", jQuery(".fusion-mobile-nav-holder").not(".fusion-mobile-sticky-nav-holder").find("> ul").attr("id")), jQuery(window).on("scroll", function() {
        setTimeout(function() {
            jQuery(".fusion-is-sticky").length && jQuery(".fusion-mobile-sticky-nav-holder").length ? jQuery(".fusion-mobile-menu-icons .awb-icon-bars").attr("aria-controls", jQuery(".fusion-mobile-sticky-nav-holder > ul").attr("id")) : jQuery(".fusion-mobile-menu-icons .awb-icon-bars").attr("aria-controls", jQuery(".fusion-mobile-nav-holder").not(".fusion-mobile-sticky-nav-holder").find("> ul").attr("id"))
        }, 50)
    }), jQuery(document).on("click", ".fusion-mobile-menu-icons .awb-icon-bars", function(e) {
        var n, i;
    ...
    }), jQuery(document).on("click", ".fusion-mobile-menu-icons .awb-icon-search", function(e) {
        ...
        e.preventDefault(), jQuery(document).off("keyup.flyoutSearchEsc"), jQuery(document).off("keyup.flyoutMenuEsc"), n.hasClass("fusion-flyout-active") ? (n.hasClass("fusion-flyout-menu-active") ? (n.addClass("fusion-flyout-search-active"), Modernizr.mq("only screen and (min-width:" + parseInt(avadaMenuVars.side_header_break_point, 10) + "px)") && n.find(".fusion-flyout-search .s").focus(), jQuery(document).on("keyup.flyoutSearchEsc", function(e) {
            27 === e.keyCode && document.querySelector(".fusion-flyout-menu-icons .fusion-icon.awb-icon-search").click()
