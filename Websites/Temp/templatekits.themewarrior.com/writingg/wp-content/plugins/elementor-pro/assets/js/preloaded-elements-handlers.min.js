...
(self.webpackChunkelementor_pro = self.webpackChunkelementor_pro || []).push([
    [995, 26, 534, 369, 804, 888, 680, 121, 288, 42, 50, 985, 287, 824, 58, 114, 443, 838, 685, 858, 102, 1, 124, 859, 979, 497, 149], {
        9978: (e, t, n) => {
            var s = n(3203),
                i = s(n(5574)),
                o = s(n(9743)),
        ...
        5030: (e, t, n) => {
            ...
            Object.defineProperty(t, "__esModule", {
                ...
                const l = createHandleElement({
                    title: i,
                    onClick: () => onDocumentClick(n, r, a)
                }, r);
                t.prepend(l), o === r && (t.dataset.editableElementorDocument = n)
            };
        ...
        7701: (e, t, n) => {
            ...
            class _default extends elementorModules.Module {
                constructor() {
                    super(), elementorFrontend.elementsHandler.attachHandler("loop-grid", o.default, "post"), elementorFrontend.elementsHandler.attachHandler("loop-grid", i.default, "post")
                }
            }
            t.default = _default
        },
        ...
        9491: (e, t, n) => {
            ...
            class LoopGrid extends o.default {
                ...
                onInit() {
                    super.onInit(...arguments), elementorFrontend.isEditMode() && (this.attachEditDocumentHandle(), this.handleCTA())
                }
            }
            t.default = LoopGrid
        },
            ...
            class LoadMore extends elementorModules.frontend.handlers.Base {
                ...
                handleSuccessFetch(e) {
                    ...
                    const t = this.getSettings("selectors"),
                        ...
                        i = [...n].reduce(((e, t) => e + t.outerHTML), "");
                    this.elements.postsContainer.insertAdjacentHTML("beforeend", i), this.elements.loadMoreAnchor.setAttribute("data-page", this.currentPage), this.elements.loadMoreAnchor.setAttribute("data-next-page", s), this.currentPage === this.maxPage && this.handleUiWhenNoPosts()
                }
                handlePostsQuery() {
